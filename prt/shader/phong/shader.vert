...
layout(location = 2) out mat3 transport;
...
void main(){
	...
	/*
	intensity.r = lightPrt.r[0][0] * transport0[0] + lightPrt.r[0][1] * transport0[1] + lightPrt.r[0][2] * transport0[2]
    ...
    intensity.g = lightPrt.g[0][0] * transport0[0] + lightPrt.g[0][1] * transport0[1] + lightPrt.g[0][2] * transport0[2]
	...
	intensity.b = lightPrt.b[0][0] * transport0[0] + lightPrt.b[0][1] * transport0[1] + lightPrt.b[0][2] * transport0[2]
