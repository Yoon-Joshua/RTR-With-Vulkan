...
//std::string MODEL_PATH = "E:/Projects/py/viking_room.obj";
std::string MODEL_PATH = "E:/model/marry/marry.obj";
...
void Scene::loadModel(Context* context) {
	...
	v[1].normal = glm::vec3(0.0, 1.0, 0.0);
	v[2].pos = glm::vec3(-side, ymin, side);
	v[2].normal = glm::vec3(0.0, 1.0, 0.0);
	v[3].pos = glm::vec3(-side, ymin, -side);
	v[3].normal = glm::vec3(0.0, 1.0, 0.0);
	for (int i = 0; i < 4; ++i) {
