...
void main(){
	...
	outNormal = (model.transform * vec4(inNormal, 0.0)).xyz;
	outPosition = (model.transform * vec4(inPosition, 1.0)).xyz;
	outTexCoord = inTexCoord;
	smCoord = lightTransform.transform * model.transform * vec4(inPosition, 1.0);
}